...
const mockUrl_3_0_0_0 = 'https://yapi.mlamp.cn/mock/926' as any;
const devUrl_3_0_0_0 = '' as any;
const prodUrl_3_0_0_0 = '' as any;
const dataKey_3_0_0_0 = undefined as any;

/**
 * 接口 [List Runs↗](https://yapi.mlamp.cn/project/926/interface/api/70380) 的 **请求类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
...
/**
 * 接口 [List Runs↗](https://yapi.mlamp.cn/project/926/interface/api/70380) 的 **返回类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs`
...
/**
 * 接口 [List Runs↗](https://yapi.mlamp.cn/project/926/interface/api/70380) 的 **请求配置的类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs`
...
/**
 * 接口 [List Runs↗](https://yapi.mlamp.cn/project/926/interface/api/70380) 的 **请求配置**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs`
...
/**
 * 接口 [List Runs↗](https://yapi.mlamp.cn/project/926/interface/api/70380) 的 **请求函数**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs`
...
/**
 * 接口 [Create Run↗](https://yapi.mlamp.cn/project/926/interface/api/70386) 的 **请求类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
...
/**
 * 接口 [Create Run↗](https://yapi.mlamp.cn/project/926/interface/api/70386) 的 **返回类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs`
...
/**
 * 接口 [Create Run↗](https://yapi.mlamp.cn/project/926/interface/api/70386) 的 **请求配置的类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs`
...
/**
 * 接口 [Create Run↗](https://yapi.mlamp.cn/project/926/interface/api/70386) 的 **请求配置**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs`
...
/**
 * 接口 [Create Run↗](https://yapi.mlamp.cn/project/926/interface/api/70386) 的 **请求函数**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs`
...
/**
 * 接口 [Get Run↗](https://yapi.mlamp.cn/project/926/interface/api/70392) 的 **请求类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
...
/**
 * 接口 [Get Run↗](https://yapi.mlamp.cn/project/926/interface/api/70392) 的 **返回类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}`
...
/**
 * 接口 [Get Run↗](https://yapi.mlamp.cn/project/926/interface/api/70392) 的 **请求配置的类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}`
...
/**
 * 接口 [Get Run↗](https://yapi.mlamp.cn/project/926/interface/api/70392) 的 **请求配置**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}`
...
/**
 * 接口 [Get Run↗](https://yapi.mlamp.cn/project/926/interface/api/70392) 的 **请求函数**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}`
...
/**
 * 接口 [Modify Run↗](https://yapi.mlamp.cn/project/926/interface/api/70398) 的 **请求类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
...
/**
 * 接口 [Modify Run↗](https://yapi.mlamp.cn/project/926/interface/api/70398) 的 **返回类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}`
...
/**
 * 接口 [Modify Run↗](https://yapi.mlamp.cn/project/926/interface/api/70398) 的 **请求配置的类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}`
...
/**
 * 接口 [Modify Run↗](https://yapi.mlamp.cn/project/926/interface/api/70398) 的 **请求配置**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}`
...
/**
 * 接口 [Modify Run↗](https://yapi.mlamp.cn/project/926/interface/api/70398) 的 **请求函数**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}`
...
/**
 * 接口 [Cancel Run↗](https://yapi.mlamp.cn/project/926/interface/api/70404) 的 **请求类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
...
/**
 * 接口 [Cancel Run↗](https://yapi.mlamp.cn/project/926/interface/api/70404) 的 **返回类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}/cancel`
...
/**
 * 接口 [Cancel Run↗](https://yapi.mlamp.cn/project/926/interface/api/70404) 的 **请求配置的类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}/cancel`
...
/**
 * 接口 [Cancel Run↗](https://yapi.mlamp.cn/project/926/interface/api/70404) 的 **请求配置**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}/cancel`
...
/**
 * 接口 [Cancel Run↗](https://yapi.mlamp.cn/project/926/interface/api/70404) 的 **请求函数**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}/cancel`
...
/**
 * 接口 [List Run Steps↗](https://yapi.mlamp.cn/project/926/interface/api/70410) 的 **请求类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
...
/**
 * 接口 [List Run Steps↗](https://yapi.mlamp.cn/project/926/interface/api/70410) 的 **返回类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}/steps`
...
/**
 * 接口 [List Run Steps↗](https://yapi.mlamp.cn/project/926/interface/api/70410) 的 **请求配置的类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}/steps`
...
/**
 * 接口 [List Run Steps↗](https://yapi.mlamp.cn/project/926/interface/api/70410) 的 **请求配置**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}/steps`
...
/**
 * 接口 [List Run Steps↗](https://yapi.mlamp.cn/project/926/interface/api/70410) 的 **请求函数**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}/steps`
...
/**
 * 接口 [Get Run Step↗](https://yapi.mlamp.cn/project/926/interface/api/70416) 的 **请求类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
...
/**
 * 接口 [Get Run Step↗](https://yapi.mlamp.cn/project/926/interface/api/70416) 的 **返回类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}/steps/{step_id}`
...
/**
 * 接口 [Get Run Step↗](https://yapi.mlamp.cn/project/926/interface/api/70416) 的 **请求配置的类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}/steps/{step_id}`
...
/**
 * 接口 [Get Run Step↗](https://yapi.mlamp.cn/project/926/interface/api/70416) 的 **请求配置**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}/steps/{step_id}`
...
/**
 * 接口 [Get Run Step↗](https://yapi.mlamp.cn/project/926/interface/api/70416) 的 **请求函数**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `GET /api/v1/threads/{thread_id}/runs/{run_id}/steps/{step_id}`
...
/**
 * 接口 [Submit Tool Ouputs To Run↗](https://yapi.mlamp.cn/project/926/interface/api/70422) 的 **请求类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
...
/**
 * 接口 [Submit Tool Ouputs To Run↗](https://yapi.mlamp.cn/project/926/interface/api/70422) 的 **返回类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}/submit_tool_outputs`
...
/**
 * 接口 [Submit Tool Ouputs To Run↗](https://yapi.mlamp.cn/project/926/interface/api/70422) 的 **请求配置的类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}/submit_tool_outputs`
...
/**
 * 接口 [Submit Tool Ouputs To Run↗](https://yapi.mlamp.cn/project/926/interface/api/70422) 的 **请求配置**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}/submit_tool_outputs`
...
/**
 * 接口 [Submit Tool Ouputs To Run↗](https://yapi.mlamp.cn/project/926/interface/api/70422) 的 **请求函数**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/{thread_id}/runs/{run_id}/submit_tool_outputs`
...
/**
 * 接口 [Create Thread And Run↗](https://yapi.mlamp.cn/project/926/interface/api/70428) 的 **请求类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
...
/**
 * 接口 [Create Thread And Run↗](https://yapi.mlamp.cn/project/926/interface/api/70428) 的 **返回类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/runs`
...
/**
 * 接口 [Create Thread And Run↗](https://yapi.mlamp.cn/project/926/interface/api/70428) 的 **请求配置的类型**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/runs`
...
type PostApiV1ThreadsRunsRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/926', '', '', '/api/v1/threads/runs', undefined, string, string, false>
>;

/**
 * 接口 [Create Thread And Run↗](https://yapi.mlamp.cn/project/926/interface/api/70428) 的 **请求配置**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/runs`
...
/**
 * 接口 [Create Thread And Run↗](https://yapi.mlamp.cn/project/926/interface/api/70428) 的 **请求函数**
 *
 * @分类 [runs↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11480)
 * @标签 `runs`
 * @请求头 `POST /api/v1/threads/runs`
