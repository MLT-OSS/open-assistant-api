...
const mockUrl_1_0_0_0 = 'https://yapi.mlamp.cn/mock/926' as any;
const devUrl_1_0_0_0 = '' as any;
const prodUrl_1_0_0_0 = '' as any;
const dataKey_1_0_0_0 = undefined as any;

/**
 * 接口 [Create Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70320) 的 **请求类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
...
/**
 * 接口 [Create Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70320) 的 **返回类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `POST /api/v1/threads`
...
/**
 * 接口 [Create Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70320) 的 **请求配置的类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `POST /api/v1/threads`
...
type PostApiV1ThreadsRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/926', '', '', '/api/v1/threads', undefined, string, string, false>
>;

/**
 * 接口 [Create Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70320) 的 **请求配置**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `POST /api/v1/threads`
...
/**
 * 接口 [Create Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70320) 的 **请求函数**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `POST /api/v1/threads`
...
/**
 * 接口 [Get Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70326) 的 **请求类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
...
/**
 * 接口 [Get Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70326) 的 **返回类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `GET /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Get Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70326) 的 **请求配置的类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `GET /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Get Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70326) 的 **请求配置**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `GET /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Get Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70326) 的 **请求函数**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `GET /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Modify Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70332) 的 **请求类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
...
/**
 * 接口 [Modify Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70332) 的 **返回类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `POST /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Modify Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70332) 的 **请求配置的类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `POST /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Modify Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70332) 的 **请求配置**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `POST /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Modify Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70332) 的 **请求函数**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `POST /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Delete Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70338) 的 **请求类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
...
/**
 * 接口 [Delete Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70338) 的 **返回类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `DELETE /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Delete Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70338) 的 **请求配置的类型**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `DELETE /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Delete Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70338) 的 **请求配置**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `DELETE /api/v1/threads/{thread_id}`
...
/**
 * 接口 [Delete Thread↗](https://yapi.mlamp.cn/project/926/interface/api/70338) 的 **请求函数**
 *
 * @分类 [threads↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11476)
 * @标签 `threads`
 * @请求头 `DELETE /api/v1/threads/{thread_id}`
