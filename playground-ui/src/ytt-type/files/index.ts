...
const mockUrl_4_0_0_0 = 'https://yapi.mlamp.cn/mock/926' as any;
const devUrl_4_0_0_0 = '' as any;
const prodUrl_4_0_0_0 = '' as any;
const dataKey_4_0_0_0 = undefined as any;

/**
 * 接口 [List Files↗](https://yapi.mlamp.cn/project/926/interface/api/70434) 的 **请求类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
...
/**
 * 接口 [List Files↗](https://yapi.mlamp.cn/project/926/interface/api/70434) 的 **返回类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files`
...
/**
 * 接口 [List Files↗](https://yapi.mlamp.cn/project/926/interface/api/70434) 的 **请求配置的类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files`
...
type GetApiV1FilesRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/926', '', '', '/api/v1/files', undefined, string, 'purpose', false>
>;

/**
 * 接口 [List Files↗](https://yapi.mlamp.cn/project/926/interface/api/70434) 的 **请求配置**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files`
...
/**
 * 接口 [List Files↗](https://yapi.mlamp.cn/project/926/interface/api/70434) 的 **请求函数**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files`
...
/**
 * 接口 [Create File↗](https://yapi.mlamp.cn/project/926/interface/api/70440) 的 **请求类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
...
/**
 * 接口 [Create File↗](https://yapi.mlamp.cn/project/926/interface/api/70440) 的 **返回类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `POST /api/v1/files`
...
/**
 * 接口 [Create File↗](https://yapi.mlamp.cn/project/926/interface/api/70440) 的 **请求配置的类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `POST /api/v1/files`
...
type PostApiV1FilesRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/926', '', '', '/api/v1/files', undefined, string, string, true>
>;

/**
 * 接口 [Create File↗](https://yapi.mlamp.cn/project/926/interface/api/70440) 的 **请求配置**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `POST /api/v1/files`
...
/**
 * 接口 [Create File↗](https://yapi.mlamp.cn/project/926/interface/api/70440) 的 **请求函数**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `POST /api/v1/files`
...
/**
 * 接口 [Retrieve File↗](https://yapi.mlamp.cn/project/926/interface/api/70446) 的 **请求类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
...
/**
 * 接口 [Retrieve File↗](https://yapi.mlamp.cn/project/926/interface/api/70446) 的 **返回类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files/{file_id}`
...
/**
 * 接口 [Retrieve File↗](https://yapi.mlamp.cn/project/926/interface/api/70446) 的 **请求配置的类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files/{file_id}`
...
/**
 * 接口 [Retrieve File↗](https://yapi.mlamp.cn/project/926/interface/api/70446) 的 **请求配置**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files/{file_id}`
...
/**
 * 接口 [Retrieve File↗](https://yapi.mlamp.cn/project/926/interface/api/70446) 的 **请求函数**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files/{file_id}`
...
/**
 * 接口 [Delete File↗](https://yapi.mlamp.cn/project/926/interface/api/70452) 的 **请求类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
...
/**
 * 接口 [Delete File↗](https://yapi.mlamp.cn/project/926/interface/api/70452) 的 **返回类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `DELETE /api/v1/files/{file_id}`
...
/**
 * 接口 [Delete File↗](https://yapi.mlamp.cn/project/926/interface/api/70452) 的 **请求配置的类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `DELETE /api/v1/files/{file_id}`
...
/**
 * 接口 [Delete File↗](https://yapi.mlamp.cn/project/926/interface/api/70452) 的 **请求配置**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `DELETE /api/v1/files/{file_id}`
...
/**
 * 接口 [Delete File↗](https://yapi.mlamp.cn/project/926/interface/api/70452) 的 **请求函数**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `DELETE /api/v1/files/{file_id}`
...
/**
 * 接口 [Download File↗](https://yapi.mlamp.cn/project/926/interface/api/70458) 的 **请求类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
...
/**
 * 接口 [Download File↗](https://yapi.mlamp.cn/project/926/interface/api/70458) 的 **返回类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files/{file_id}/content`
...
/**
 * 接口 [Download File↗](https://yapi.mlamp.cn/project/926/interface/api/70458) 的 **请求配置的类型**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files/{file_id}/content`
...
/**
 * 接口 [Download File↗](https://yapi.mlamp.cn/project/926/interface/api/70458) 的 **请求配置**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files/{file_id}/content`
...
/**
 * 接口 [Download File↗](https://yapi.mlamp.cn/project/926/interface/api/70458) 的 **请求函数**
 *
 * @分类 [files↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11482)
 * @标签 `files`
 * @请求头 `GET /api/v1/files/{file_id}/content`
