...
const mockUrl_0_0_0_0 = 'https://yapi.mlamp.cn/mock/926' as any;
const devUrl_0_0_0_0 = '' as any;
const prodUrl_0_0_0_0 = '' as any;
const dataKey_0_0_0_0 = undefined as any;

/**
 * 接口 [List Assistants↗](https://yapi.mlamp.cn/project/926/interface/api/70266) 的 **请求类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
...
/**
 * 接口 [List Assistants↗](https://yapi.mlamp.cn/project/926/interface/api/70266) 的 **返回类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants`
...
/**
 * 接口 [List Assistants↗](https://yapi.mlamp.cn/project/926/interface/api/70266) 的 **请求配置的类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants`
...
/**
 * 接口 [List Assistants↗](https://yapi.mlamp.cn/project/926/interface/api/70266) 的 **请求配置**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants`
...
/**
 * 接口 [List Assistants↗](https://yapi.mlamp.cn/project/926/interface/api/70266) 的 **请求函数**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants`
...
/**
 * 接口 [Create Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70272) 的 **请求类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
...
/**
 * 接口 [Create Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70272) 的 **返回类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants`
...
/**
 * 接口 [Create Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70272) 的 **请求配置的类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants`
...
type PostApiV1AssistantsRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/926', '', '', '/api/v1/assistants', undefined, string, string, false>
>;

/**
 * 接口 [Create Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70272) 的 **请求配置**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants`
...
/**
 * 接口 [Create Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70272) 的 **请求函数**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants`
...
/**
 * 接口 [Get Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70278) 的 **请求类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
...
/**
 * 接口 [Get Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70278) 的 **返回类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Get Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70278) 的 **请求配置的类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Get Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70278) 的 **请求配置**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Get Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70278) 的 **请求函数**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Modify Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70284) 的 **请求类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
...
/**
 * 接口 [Modify Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70284) 的 **返回类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Modify Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70284) 的 **请求配置的类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Modify Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70284) 的 **请求配置**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Modify Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70284) 的 **请求函数**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Delete Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70290) 的 **请求类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
...
/**
 * 接口 [Delete Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70290) 的 **返回类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `DELETE /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Delete Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70290) 的 **请求配置的类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `DELETE /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Delete Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70290) 的 **请求配置**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `DELETE /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [Delete Assistant↗](https://yapi.mlamp.cn/project/926/interface/api/70290) 的 **请求函数**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `DELETE /api/v1/assistants/{assistant_id}`
...
/**
 * 接口 [List Assistant Files↗](https://yapi.mlamp.cn/project/926/interface/api/70296) 的 **请求类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
...
/**
 * 接口 [List Assistant Files↗](https://yapi.mlamp.cn/project/926/interface/api/70296) 的 **返回类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}/files`
...
/**
 * 接口 [List Assistant Files↗](https://yapi.mlamp.cn/project/926/interface/api/70296) 的 **请求配置的类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}/files`
...
/**
 * 接口 [List Assistant Files↗](https://yapi.mlamp.cn/project/926/interface/api/70296) 的 **请求配置**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}/files`
...
/**
 * 接口 [List Assistant Files↗](https://yapi.mlamp.cn/project/926/interface/api/70296) 的 **请求函数**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}/files`
...
/**
 * 接口 [Create Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70302) 的 **请求类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
...
/**
 * 接口 [Create Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70302) 的 **返回类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants/{assistant_id}/files`
...
/**
 * 接口 [Create Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70302) 的 **请求配置的类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants/{assistant_id}/files`
...
/**
 * 接口 [Create Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70302) 的 **请求配置**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants/{assistant_id}/files`
...
/**
 * 接口 [Create Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70302) 的 **请求函数**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `POST /api/v1/assistants/{assistant_id}/files`
...
/**
 * 接口 [Get Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70308) 的 **请求类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
...
/**
 * 接口 [Get Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70308) 的 **返回类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}/files/{file_id}`
...
/**
 * 接口 [Get Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70308) 的 **请求配置的类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}/files/{file_id}`
...
/**
 * 接口 [Get Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70308) 的 **请求配置**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}/files/{file_id}`
...
/**
 * 接口 [Get Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70308) 的 **请求函数**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `GET /api/v1/assistants/{assistant_id}/files/{file_id}`
...
/**
 * 接口 [Delete Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70314) 的 **请求类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
...
/**
 * 接口 [Delete Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70314) 的 **返回类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `DELETE /api/v1/assistants/{assistant_id}/files/{file_id}`
...
/**
 * 接口 [Delete Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70314) 的 **请求配置的类型**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `DELETE /api/v1/assistants/{assistant_id}/files/{file_id}`
...
/**
 * 接口 [Delete Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70314) 的 **请求配置**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `DELETE /api/v1/assistants/{assistant_id}/files/{file_id}`
...
/**
 * 接口 [Delete Assistant File↗](https://yapi.mlamp.cn/project/926/interface/api/70314) 的 **请求函数**
 *
 * @分类 [assistants↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11474)
 * @标签 `assistants`
 * @请求头 `DELETE /api/v1/assistants/{assistant_id}/files/{file_id}`
