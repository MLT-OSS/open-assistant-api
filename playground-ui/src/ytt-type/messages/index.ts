...
const mockUrl_2_0_0_0 = 'https://yapi.mlamp.cn/mock/926' as any;
const devUrl_2_0_0_0 = '' as any;
const prodUrl_2_0_0_0 = '' as any;
const dataKey_2_0_0_0 = undefined as any;

/**
 * 接口 [List Messages↗](https://yapi.mlamp.cn/project/926/interface/api/70344) 的 **请求类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
...
/**
 * 接口 [List Messages↗](https://yapi.mlamp.cn/project/926/interface/api/70344) 的 **返回类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages`
...
/**
 * 接口 [List Messages↗](https://yapi.mlamp.cn/project/926/interface/api/70344) 的 **请求配置的类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages`
...
/**
 * 接口 [List Messages↗](https://yapi.mlamp.cn/project/926/interface/api/70344) 的 **请求配置**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages`
...
/**
 * 接口 [List Messages↗](https://yapi.mlamp.cn/project/926/interface/api/70344) 的 **请求函数**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages`
...
/**
 * 接口 [Create Message↗](https://yapi.mlamp.cn/project/926/interface/api/70350) 的 **请求类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
...
/**
 * 接口 [Create Message↗](https://yapi.mlamp.cn/project/926/interface/api/70350) 的 **返回类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `POST /api/v1/threads/{thread_id}/messages`
...
/**
 * 接口 [Create Message↗](https://yapi.mlamp.cn/project/926/interface/api/70350) 的 **请求配置的类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `POST /api/v1/threads/{thread_id}/messages`
...
/**
 * 接口 [Create Message↗](https://yapi.mlamp.cn/project/926/interface/api/70350) 的 **请求配置**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `POST /api/v1/threads/{thread_id}/messages`
...
/**
 * 接口 [Create Message↗](https://yapi.mlamp.cn/project/926/interface/api/70350) 的 **请求函数**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `POST /api/v1/threads/{thread_id}/messages`
...
/**
 * 接口 [Get Message↗](https://yapi.mlamp.cn/project/926/interface/api/70356) 的 **请求类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
...
/**
 * 接口 [Get Message↗](https://yapi.mlamp.cn/project/926/interface/api/70356) 的 **返回类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}`
...
/**
 * 接口 [Get Message↗](https://yapi.mlamp.cn/project/926/interface/api/70356) 的 **请求配置的类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}`
...
/**
 * 接口 [Get Message↗](https://yapi.mlamp.cn/project/926/interface/api/70356) 的 **请求配置**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}`
...
/**
 * 接口 [Get Message↗](https://yapi.mlamp.cn/project/926/interface/api/70356) 的 **请求函数**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}`
...
/**
 * 接口 [Modify Message↗](https://yapi.mlamp.cn/project/926/interface/api/70362) 的 **请求类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
...
/**
 * 接口 [Modify Message↗](https://yapi.mlamp.cn/project/926/interface/api/70362) 的 **返回类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `POST /api/v1/threads/{thread_id}/messages/{message_id}`
...
/**
 * 接口 [Modify Message↗](https://yapi.mlamp.cn/project/926/interface/api/70362) 的 **请求配置的类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `POST /api/v1/threads/{thread_id}/messages/{message_id}`
...
/**
 * 接口 [Modify Message↗](https://yapi.mlamp.cn/project/926/interface/api/70362) 的 **请求配置**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `POST /api/v1/threads/{thread_id}/messages/{message_id}`
...
/**
 * 接口 [Modify Message↗](https://yapi.mlamp.cn/project/926/interface/api/70362) 的 **请求函数**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `POST /api/v1/threads/{thread_id}/messages/{message_id}`
...
/**
 * 接口 [List Message Files↗](https://yapi.mlamp.cn/project/926/interface/api/70368) 的 **请求类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
...
/**
 * 接口 [List Message Files↗](https://yapi.mlamp.cn/project/926/interface/api/70368) 的 **返回类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}/files`
...
/**
 * 接口 [List Message Files↗](https://yapi.mlamp.cn/project/926/interface/api/70368) 的 **请求配置的类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}/files`
...
/**
 * 接口 [List Message Files↗](https://yapi.mlamp.cn/project/926/interface/api/70368) 的 **请求配置**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}/files`
...
/**
 * 接口 [List Message Files↗](https://yapi.mlamp.cn/project/926/interface/api/70368) 的 **请求函数**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}/files`
...
/**
 * 接口 [Get Message File↗](https://yapi.mlamp.cn/project/926/interface/api/70374) 的 **请求类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
...
/**
 * 接口 [Get Message File↗](https://yapi.mlamp.cn/project/926/interface/api/70374) 的 **返回类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}/files/{file_id}`
...
/**
 * 接口 [Get Message File↗](https://yapi.mlamp.cn/project/926/interface/api/70374) 的 **请求配置的类型**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}/files/{file_id}`
...
/**
 * 接口 [Get Message File↗](https://yapi.mlamp.cn/project/926/interface/api/70374) 的 **请求配置**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}/files/{file_id}`
...
/**
 * 接口 [Get Message File↗](https://yapi.mlamp.cn/project/926/interface/api/70374) 的 **请求函数**
 *
 * @分类 [messages↗](https://yapi.mlamp.cn/project/926/interface/api/cat_11478)
 * @标签 `messages`
 * @请求头 `GET /api/v1/threads/{thread_id}/messages/{message_id}/files/{file_id}`
